...
<?php include('session.php'); ?>    
	...
	<hr>
	Distrito:<input name="distrito" type="text" value="<?php echo $row['distrito']; ?>">
	<hr>
	Móvil:<input name="mobile" type="text" value="<?php echo $row['mobile']; ?>">
	<hr>
	Posicion:<input name="posicion" type="text" value="<?php echo $row['posicion']; ?>">
	<hr>
	Hobby:<input name="hobby" type="text" value="<?php echo $row['hobby']; ?>">
	<hr>
	<br>
			<center>
